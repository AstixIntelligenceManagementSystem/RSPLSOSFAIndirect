...
public class WebViewPurchaseOrderActivity extends Activity {
    ...
    public void customHeader()
    {
        ...
        tv_heading.setText(getText(R.string.PurchaseOrderDetails));
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
      ...
      /*  String SONodeIdAndNodeType= dbengine.fnGetPersonNodeIDAndPersonNodeTypeForSO();
        ...
        if(isOnline())
        {
            ...
            try
            {
                progressDialog = new ProgressDialog(WebViewPurchaseOrderActivity.this);
                ...
                ImageUrl= CommonInfo.WebPurchaseOrderUrl.trim();
               // ImageUrl=ImageUrl+"?ImeINo="+imei;
                ImageUrl=ImageUrl+"?ImeINo="+imei+"&flgType="+2;
    ...
    {
        AlertDialog.Builder alertDialogNoConn = new AlertDialog.Builder(WebViewPurchaseOrderActivity.this);
