		 ...
		 Manufacture_rateSpinner.setOnClickListener(new OnClickListener() 
		 {
			...
			public void onClick(View v) 
			{
			  ...
			  //hashmap data setting to adapter
			  		...
			  		{
			  			Toast.makeText(getActivity(), getResources().getString(R.string.txtNoRecord), Toast.LENGTH_SHORT).show();
			  			return;
			  		}
	...
	btnGo.setOnClickListener(new OnClickListener()
	{
		...
		public void onClick(View arg0) 
		{
			...
			if(CommonInfo.quatationFlag.equals("NEW"))
			{
				...
				{
					allMessageAlert(getResources().getString(R.string.FillCstrmrInfo));
				...
				else
				{
					...
					{
						allMessageAlert(getResources().getString(R.string.TextToFilter));
						...
						if(allDataParent.getChildCount()>0){
						 ...
						 QuotationActivityLayout.setEnabled(true);
							...
							getActivity().getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
							 AlertDialog.Builder alertDialogNoConn = new AlertDialog.Builder(getActivity());
								alertDialogNoConn.setTitle(getResources().getString(R.string.genTermInformation));
								alertDialogNoConn.setMessage(getResources().getString(R.string.PutExtraFilter));
								//alertDialogNoConn.setMessage(getText(R.string.connAlertErrMsg));
								alertDialogNoConn.setNeutralButton(getResources().getString(R.string.AlertDialogOkButton),
										new DialogInterface.OnClickListener() {
											public void onClick(DialogInterface dialog, int which) 
		...
		protected void onPostExecute(Void result)
		{
            ...
            else
            {
            	if(hashmapForDynamicViewFromDataBase.size()>0){
    				...
    				gifView.setVisibility(View.GONE);
    				getActivity().getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
    				Toast.makeText(getActivity().getApplicationContext(), getResources().getString(R.string.NoDataFound), Toast.LENGTH_SHORT).show();
