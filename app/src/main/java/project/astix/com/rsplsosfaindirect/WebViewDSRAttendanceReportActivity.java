...
public class WebViewDSRAttendanceReportActivity extends BaseActivity
{
    ...
    public void customHeader()
    {
       ...
       // tv_heading.setText(getText(R.string.ManageDSRMsg));
        tv_heading.setText("DSR Attendance");
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
      ...
      /*  String SONodeIdAndNodeType= dbengine.fnGetPersonNodeIDAndPersonNodeTypeForSO();
        ...
        if(isOnline())
        {
            ...
            try
            {
                progressDialog = new ProgressDialog(WebViewDSRAttendanceReportActivity.this);
                ...
                ImageUrl= CommonInfo.WebDSRAttendanceUrl.trim();
    ...
    {
        AlertDialog.Builder alertDialogNoConn = new AlertDialog.Builder(WebViewDSRAttendanceReportActivity.this);
