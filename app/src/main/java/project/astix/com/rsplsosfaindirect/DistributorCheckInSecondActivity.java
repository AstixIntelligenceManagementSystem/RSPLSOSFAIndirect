...
public class DistributorCheckInSecondActivity extends BaseActivity
{
    ...
    Dialog dialog;
    private int StockPcsCaseType=0;
    private RadioButton 	RB_inpieces;
    private RadioButton 	RB_InCases;
    private LinearLayout lLayout_main;
    private LinearLayout ll_forSearchBox;
    private LinearLayout ll_forTableHeaderName;
    private RelativeLayout relLayout_img;
    private ImageView btn_search;
    private ImageView imgVw_back;
    private EditText edittext;
    private TextView txt_stockDate;
    private TextView txt_stockEntry_Cases;
    private LinearLayout LLparentOfInPcsCs;
    private Button btn_save;
    private Spinner spinner_for_filter;
    private String DbrNodeId;
    private String DbrNodeType;
    private String DbrName;
    private int DistribtrId_Global=0;
    private final int Sstat=3;
    private LinearLayout llayout_dialog_parentOfRows;
    private TextView oldStck_BtnGlobal;

    private final DBAdapterKenya dbengine = new DBAdapterKenya(DistributorCheckInSecondActivity.this);
    private int chkFlgForErrorToCloseApp = 0;
    private String imei;
    private String fDate;
    int CstomrNodeType=0;

    private int DistributorNodeType_Global=0;
    private TextView txt_mnth1;
    private TextView txt_mnth2;
    private TextView txt_mnth3;
    private TextView txt_mnth4;
    private TextView txt_mnth5;

    private final LinkedHashMap<String, String> HmapDistribtrOldStockData = new LinkedHashMap<>();
    private LinkedHashMap<String, String> HmapDistribtrReport = new LinkedHashMap<>();
    private final LinkedHashMap<String, String> HmapSavedData = new LinkedHashMap<>();
    private LinkedHashMap<String, String> HmapGetPDAdata;
    private LinkedHashMap<String, String> HmapGetPDAOldStockData;

    private ArrayList<String> DistribtrReportColumnDesc;
    private ArrayList<String> ListMnthNames;
    private final ArrayList<String> ArrayListMnth = new ArrayList<>();
    private final ArrayList<String> DbrArray= new ArrayList<>();
    private String[] Distribtr_list;

    private String[] PName=null;

    private ProgressDialog pDialog2STANDBY;
    private final DatabaseAssistantDistributorCheckIn DA = new DatabaseAssistantDistributorCheckIn(this);
    private String newfullFileName;

    private SyncXMLfileData task2;
    ...
    //report alert
    private String[] Distribtr_list_alert;
    private String DbrSelNodeId;
    private String DbrSelNodeType;
    private String DbrSelName;
    private final ArrayList<String> DbrSelArray= new ArrayList<>();
    private final LinkedHashMap<String,String> hmapDistrbtrList=new LinkedHashMap<>();
            ...
            btn_save.setOnClickListener(new OnClickListener()
            {
                ...
                public void onClick(View v)
                {
                    if(isOnline())
                    {
                        ...
                        dialog.setMessage("Are you sure to submit Distributor Stock Entry. ");
    ...
    private void getDistribtrList()
    {
        dbengine.open();

        Distribtr_list_alert=dbengine.getDistributorDataMstr();
        dbengine.close();
        for (String value : Distribtr_list_alert) {
    ...
    private void saveDistributorStockInTable()
    {
        ...
        try
        {
            if(lLayout_main.getChildCount()>0)
            {
                ...
                for(Map.Entry<String, String> entry:HmapSavedData.entrySet())
                {
                    ...
                    String tag= key.split(Pattern.quote("^"))[0].trim();
                    ...
                    String header= key.split(Pattern.quote("^"))[1].trim();
                    String Short_name= key.split(Pattern.quote("^"))[2].trim();
                    int EntryType=Integer.parseInt(key.split(Pattern.quote("^"))[3].trim());
                    ...
                    int ProductNodeType=Integer.parseInt(ProductNodeTypeStockDate.split(Pattern.quote("^"))[0].trim());
                    String StockDate= ProductNodeTypeStockDate.split(Pattern.quote("^"))[1].trim();
    ...
    private void fnSearchProduct(String item)
    {
        int check = 0;
        for (int child = 0; child < lLayout_main.getChildCount(); child++)
        {
    ...
    private void fnToAddRows()
    {
        ...
        for (int n = 0; n < ListMnthNames.size(); n++)
        {
            ...
            String ColumnName = values.split(Pattern.quote("^"))[0].trim();
            String ColumnNameDesc = values.split(Pattern.quote("^"))[1].trim();
            ArrayListMnth.add(n, ColumnNameDesc);
        }
        lLayout_main.removeAllViews();
        for (String aPName : PName) {
            ...
            textView_PrdctHeader.setText(aPName);
            ...
            dbengine.open();
            String[] PIDAndShortName = dbengine.getPrdctIdAndSku(aPName, DistribtrId_Global, DistributorNodeType_Global);
            dbengine.close();

            //ll_forRow.removeAllViews();
            for (String text : PIDAndShortName) {
                final String PrdctId = text.split(Pattern.quote("^"))[0].trim();
                final String SkuShortName = text.split(Pattern.quote("^"))[1].trim();
    ...
    private void fnGetSavedDataFromPDA()
    {
    ...
    private void fnSaveOldStockData(int DistID, int DistNodeType)
    {
        dbengine.open();
    ...
    private void putDataToHashmapOfpopup(String tagOfButton, LinkedHashMap<String, String> hmapforddd) {
    ...
    private void fnGetDistributorList()
    {
        dbengine.open();
        Distribtr_list=dbengine.getDistributorData();
        dbengine.close();
        for (String value : Distribtr_list) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(DistributorCheckInSecondActivity.this, R.layout.initial_spinner_text, DbrArray);
    ...
    private void fnOpenAlertForOldStock(String tagForBtn)
    {
        ...
        if(!HmapForDates.isEmpty() && HmapForDates != null)
        {
            for(Map.Entry<String, String> entry: HmapForDates.entrySet())
            {
                ...
                final String mnth_Date= entry.getKey().trim();
...
*/	}
    ...
    private void showNoConnAlertforLocalDataSaved()
    {
    ...
    class GetDistributorStockEntryData extends AsyncTask<Void, Void, Void>
    {
        final ProgressDialog pDialogGetStores = new ProgressDialog(DistributorCheckInSecondActivity.this);
    ...
    private class FullSyncDataNow extends AsyncTask<Void, Void, Void>
    {
        ...
        FullSyncDataNow(DistributorCheckInSecondActivity activity)
        {
    ...
    private class SyncXMLfileData extends AsyncTask<Void, Void, Integer> {
        ...
        SyncXMLfileData(DistributorCheckInSecondActivity activity) {
            pDialogGetStores = new ProgressDialog(activity);
        }
        ...
        protected Integer doInBackground(Void... params) {
            ...
            if (AllFilesName.length > 0) {
                ...
                for (String fileUri : AllFilesName) {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (isOnline()) {
                ...
                alertDialogSyncOK.setMessage("Distributor Data Submit Successfully.");
    ...
    private int upLoad2ServerXmlFiles(String fileUri)
    {
        ...
        //String sourceFileUri = newzipfile;
    ...
    private void delXML(String delPath)
    {
