...
public class WebViewDSRDataReportActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
      ...
      /*  String SONodeIdAndNodeType= dbengine.fnGetPersonNodeIDAndPersonNodeTypeForSO();
        ...
        if(isOnline())
        {
            ...
            try
            {
                progressDialog = new ProgressDialog(WebViewDSRDataReportActivity.this);
                ...
                ImageUrl= CommonInfo.WebPageUrlDataReport.trim();
    ...
    {
        AlertDialog.Builder alertDialogNoConn = new AlertDialog.Builder(WebViewDSRDataReportActivity.this);
            ...
            runOnUiThread(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    if(progressDialog.isShowing())
                    {
                        ...
                        alertDialogNoConn.setNegativeButton("Abort/Cancel",
                                new DialogInterface.OnClickListener()
                                {
                                    public void onClick(DialogInterface dialog, int which)
                                    {
