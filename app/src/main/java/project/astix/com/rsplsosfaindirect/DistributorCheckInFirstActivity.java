...
{
    private final LinkedHashMap<String,String> hmapDistributorListWithRemapFlg= new LinkedHashMap<>();
    private final LinkedHashMap<String,String> hmapDistributorListWithNodeIDType= new LinkedHashMap<>();
    private String gblSelectedDistributor="Select Distributor";
    private String UniqueDistribtrMapId;
    ...
    private String ProviderFromLauncher="NA";
    ...
    private String fnAddressFromLauncher="NA";
    ...
    private static int flgLocationServicesOnOff=0;
    private static int flgGPSOnOff=0;
    private static int flgNetworkOnOff=0;
    private static int flgFusedOnOff=0;
    private static int flgInternetOnOffWhileLocationTracking=0;
    ...
    public static String latitudeToSave;
    public static String longitudeToSave;
    public static String accuracyToSave;
    private int countSubmitClicked=0;
    private int refreshCount=0;
    private String imei;
    private String fDate;
    private LinearLayout ll_locationDetails;
    ...
    private TextView tv_MapLocationCorrectText;
    private EditText edit_gstYesVal;
    ...
    private RadioButton rb_gstPending;
    ...
    private final String StoreName="NA";

    private String[] Distribtr_list;

    private LinearLayout ll_address_section;
    private LinearLayout ll_local_area;
    private LinearLayout ll_gstDetails;
    ...
    private static final String VisitStartTS="NA";
    String flgGSTCapture="NA";
    private AlertDialog GPSONOFFAlert=null;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //this activity is a copy of Distributor Map Activity-------------
        //make sure to do the changes if using this activity--------------
        refreshCount=0;
    ...
    private SpannableStringBuilder textWithMandatory(String text_Value)
    {
        String colored = "*";
        SpannableStringBuilder builder = new SpannableStringBuilder();

        builder.append(text_Value);
    ...
    private void fnGetDistributorList()
    {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(DistributorCheckInFirstActivity.this, R.layout.initial_spinner_text, DbrArray);
                    ...
                    if(hmapDistributorListWithRemapFlg.size()>0)
                    {
                        if(hmapDistributorListWithRemapFlg.containsKey(text))
                        {
                            if(Integer.parseInt(hmapDistributorListWithRemapFlg.get(text))==0)
                            {
                                ...
                                alertDialogSubmitConfirm.setMessage(getResources().getString(R.string.DbrMapped));
                                alertDialogSubmitConfirm.setCancelable(false);

                                alertDialogSubmitConfirm.setNeutralButton(getResources().getString(R.string.AlertDialogOkButton), new DialogInterface.OnClickListener()
                                {
    ...
    private void locationRetreivingAndSetToMap()
    {
...
/*
                ...
                else
                {
                    ...
                    if(countSubmitClicked == 0)
                    {
                        ...
                        // Setting Dialog Message
                        alertDialog.setMessage(getResources().getString(R.string.AlertSameLoc));
    ...
    private boolean checkLastFinalLoctionIsRepeated(String currentLat, String currentLong, String currentAccuracy){
    ...
    private void fnCreateLastKnownFinalLocation(String chekLastGPSLat, String chekLastGPSLong, String chekLastGpsAccuracy)
    {
   ...
   private String getAddressOfProviders(String latti, String longi){
    ...
    private void checkHighAccuracyLocationMode(Context context) {
        int locationMode = 0;
           ...
           /* AddressFromLauncher = allLoctionDetails.split(Pattern.quote("^"))[3];
            ...
            if (addresses != null && addresses.size() > 0){
                ...
                if(addresses.get(0).getLocality()!=null){
                    ...
                    DistributorCheckInFirstActivity.city =city;
                }

                if(addresses.get(0).getAdminArea()!=null){
                    state=addresses.get(0).getAdminArea();
                    DistributorCheckInFirstActivity.state =state;
                }
    ...
    private void saveDataToDatabase()
    {
       ...
       /* if (ll_gstDetails.getVisibility() == View.VISIBLE)
        ...
        //this function is same as distributor mapping's saving function,-------------------------------
        //So please make new saving function for check in activity--------------------------------------
